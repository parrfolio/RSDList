---
applyTo: "**/memory-bank/**, **/Copilot-Processing.md"
---
...
The `/memories/repo/` directory contains persistent workspace memory that loads automatically in every VS Code session. Agents should update these files when significant changes occur:

- **conventions.md** — Update when coding standards, commit formats, or file organization patterns change
- **architecture.md** — Update when architectural patterns, hook systems, or agent pipeline changes are made
- **decisions-log.md** — Append new entries when architectural or technology decisions are made
- **active-work.md** — Update when changing branches, starting new features, or completing milestones
- **project-state.md** — Update when project identity, stack, or key conventions change

When making a significant decision or establishing a new pattern, add it to the appropriate memory file so future sessions inherit the knowledge without re-discovery.
