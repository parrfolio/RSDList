...
> **Deterministic enforcement:** These rules are enforced by the Copilot Hook `no-heredoc-guard.sh` in `.github/hooks/pre-tool-use/`. The hook blocks violations automatically before they execute.
