...
<div className="space-y-1.5">
  <label className="text-sm font-normal text-neutral-900">Email address</label>
  <input
    type="email"
...
```jsx
<div className="space-y-1.5">
  <label className="text-sm font-normal text-neutral-900">Country</label>
...
<div className="px-4 py-3 space-y-3">
  ...
  <div className="bg-white rounded-lg border border-neutral-200 p-4">
    <h3 className="text-base font-medium text-neutral-950 mb-3">
      Recent Activity
    </h3>
    {/* Card content */}
  </div>
...
<DropdownMenu>
  ...
  <DropdownMenuContent
    align="end"
    className="w-48 rounded-xl shadow-md border border-neutral-200"
  >
