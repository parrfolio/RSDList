...
name: design-system
description: >
  Design system for generating consistent, production-grade SaaS UI.
  ...
  design system", "match our look", "use the design system", or asks you to build any kind of app
  or interface, use this skill. Also trigger when restyling or theming existing UI to match
  the project's visual language. This skill takes priority over generic frontend-design guidance.
agents:
  [
