...
handoffs:
  - label: Create Plan
    agent: delivery.tpm
    prompt: "Create an implementation plan incorporating the critical analysis above."
    send: false
  - label: Orchestrate Build
    agent: conductor.powder
    prompt: "Orchestrate the implementation incorporating the critical analysis above."
    send: false
---
