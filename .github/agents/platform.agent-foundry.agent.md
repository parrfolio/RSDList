...
handoffs:
  - label: Integrate Agent
    agent: platform.system-maintenance
    prompt: "Integrate the newly created agent above into the agent awareness chain."
    send: false
  - label: Document Agent
    agent: documentation.technical-writer
    prompt: "Write documentation for the new agent created above."
    send: false
---
